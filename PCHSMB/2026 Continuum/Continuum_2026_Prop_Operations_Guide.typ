...
#text(size: 7.2pt, fill: rgb("#4a5568"))[
  *Authoritative Subproject Technical Manuals & Construction Deliverables:* \
  • *Duck Blinds / Sideline Screens:* See _Sideline Screen / Duck Blind Construction and Field Operations Manual_ (Release v0 (D32), 26 pages). Covers 3/4-in. EMT conduit framing, Two-Student Direct Carry, Section 2.9.3 engineered semicircular wind relief flaps (6 flaps, $R = 4.0$ in.), and on-prop placards. \
  • *Rolling Backdrops:* See _Backdrop Construction and Assembly Guide_ (Release v0 (D6), 28 pages). Covers 2x4 rolling cart base, 1-5/8-in. steel frame, 3/4-in. iron wing ballast posts, Section 2.9.3 semicircular wind relief flaps (8 flaps, $R = 4.0$ in.), and rear-rail leverage optimization. \
